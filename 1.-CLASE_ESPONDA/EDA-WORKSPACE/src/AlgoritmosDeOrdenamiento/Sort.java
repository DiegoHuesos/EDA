...
public class Sort <T extends Comparable<T> >{
    ...
    ** Nota: Para que un hacker no abuse de mi método hay que agarrar un número aleatorio. */
    ...
    public static void main (String [] args){
        Sort s = new Sort();
        Integer [] arr = {4,9, 7, 3, 1, 2, 10, 0};
        System.out.println("Original Array: " + s.arrayToString(arr));
        
        s.iterativeMergeSort(arr);
        
        System.out.println("MergeSorted Array: " + s.arrayToString(arr));
    }
